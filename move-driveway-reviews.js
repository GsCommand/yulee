...
.driveway-static-proof{width:min(1180px,calc(100% - 40px));margin:8px auto 42px;padding:0}
...
@media(max-width:560px){.driveway-static-proof{width:min(100% - 24px,1180px);margin-bottom:30px}.driveway-static-proof-inner{padding:22px 16px;border-radius:21px}.driveway-static-review{padding:20px 18px}}
</style>`;
...
if (reviewPos < 0 || staticPos < 0 || wildlightPos < 0 || !(reviewPos < staticPos && staticPos < wildlightPos)) {
  throw new Error('Reviews widget, static proof and Wildlight section are not in the requested order.');
}
...
console.log('Moved Recent reviews above Wildlight and added three static Yulee homeowner reviews beneath it.');
