...
.pricing-section .pricing-calculator{position:sticky!important;top:120px!important;padding:clamp(24px,3vw,32px)!important;border:1px solid #d7e6ef!important;border-radius:28px!important;background:#fff!important;box-shadow:0 18px 46px rgba(11,45,74,.10)!important}
.pricing-section .pricing-calculator>.section-heading{margin-bottom:18px!important;text-align:left!important}
.pricing-section .pricing-calculator>.section-heading h3{margin-top:0!important;color:#0b2d4a!important}
@media(max-width:900px){.home-why-calculator-grid{grid-template-columns:1fr!important}.pricing-section .pricing-calculator{position:static!important}.home-why-panel{border-radius:22px!important}}
