...
.driveway-condition-image{position:relative;margin:0;min-width:0;border:1px solid #d8e4ed;border-left:5px solid #39bfea;border-radius:20px;padding:10px;background:linear-gradient(135deg,#f0f9ff 0%,#fff 72%);box-shadow:0 10px 26px rgba(11,45,74,.07),0 18px 42px rgba(57,191,234,.22);min-height:100%;overflow:hidden}
.driveway-condition-image img{display:block;width:100%;height:100%;min-height:540px;object-fit:cover;object-position:center;border-radius:13px}
...
@media(max-width:560px){.driveway-condition-card{padding:18px 16px 18px;gap:12px;border-radius:17px}.driveway-condition-number{width:38px;height:38px;border-radius:11px}.driveway-condition-image{border-radius:17px;padding:8px}.driveway-condition-image img{border-radius:11px}}
</style>`;
...
console.log('Styled driveway surface-condition section with three stacked cards and Step-1-style blue image frame.');
