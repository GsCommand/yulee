...
.faq-section .faq-item summary{font-size:1.16rem;line-height:1.45;padding:20px 22px;font-weight:850}
.faq-section .faq-item p{font-size:1.09rem!important;line-height:1.75;padding:0 22px 22px}
...
if (html.includes('Published starting rates')) {
  throw new Error('Published starting rates label still present on driveway page');
}

fs.writeFileSync(file, html);
console.log('Removed driveway rates label and enlarged driveway FAQ questions and answers');
